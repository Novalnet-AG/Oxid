...
class NovalnetUtil {
     ...
     * @var string
     */
    public $sNovalnetVersion = '11.4.3';
    ...
    {
        $sErrorMessage = !empty($aResponse['status_desc']) ? $aResponse['status_desc'] : (!empty($aResponse['status_text']) ? $aResponse['status_text'] : (!empty($aResponse['status_message']) ? $aResponse['status_message'] : ''));
