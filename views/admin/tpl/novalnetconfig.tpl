                ...
                <div class="configCnt" style="display:none;" id="creditcard_config">
                    ...
                    <dl>
                        <dd>
                            ...
                            <input type="checkbox" name="aNovalnetConfig[blCreditcardInlineForm]" value="1" [{if !isset($aNovalnetConfig.blCreditcardInlineForm) || $aNovalnetConfig.blCreditcardInlineForm}]checked="checked"[{/if}]/>
