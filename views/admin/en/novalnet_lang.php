...
$aLang = [
    ...
    'NOVALNET_PRODUCT_ACTIVATION_KEY_DESCRIPTION' => 'Get your Product activation key from the <a style="font-weight: bold; color:#0080c9;" href="https://admin.novalnet.de" target="_blank">Novalnet Admin Portal</a>: PROJECT > Choose your project > Shop Parameters > API Signature (Product activation key)" >Novalnet Merchant Administration portal</a> - PROJECTS: Project Information - Shop Parameters: API Signature (Product activation key)',
    ...
    'NOVALNET_AMOUNT_REFUNDED_CHILD_TID_MESSAGE'  => '. New TID: %s for the refunded amount: %s',
    ...
    'NOVALNET_ADMIN_UPDATE_VERSION'                   => '<h2><b>Novalnet Payment Module V11.4.3</b></h2>',
