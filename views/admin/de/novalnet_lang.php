...
$aLang = [
    ...
    'NOVALNET_ADMIN_CONFIG_MESSAGE' => 'Bevor Sie beginnen, lesen Sie bitte die Installationsanleitung und melden Sie sich mit Ihrem H&auml;ndlerkonto im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a> an. Um ein H&aumlndlerkonto zu erhalten, senden Sie bitte eine E-Mail an <a style="font-weight: bold; color:#0080c9" href="mailto:sales@novalnet.de">sales@novalnet.de</a> oder rufen Sie uns unter +49 89 923068320 an</span><br/><br/><span style="font-weight: bold; color:#878787;">Um PayPal-Transaktionen zu akzeptieren, konfigurieren Sie Ihre PayPal-API-Informationen im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a>> PROJEKT > Wählen Sie Ihr Projekt > Zahlungsmethoden > Paypal > Konfigurieren',
    ...
    'NOVALNET_CLIENT_KEY_DESCRIPTION'             => '',
    ...
    'NOVALNET_PRODUCT_ACTIVATION_KEY_DESCRIPTION' => 'Ihren Produktaktivierungsschlüssel finden Sie im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a>: PROJEKT > W&auml;hlen Sie Ihr Projekt > Shop-Parameter > API-Signatur (Produktaktivierungsschl&uuml;ssel)',
    ...
    'NOVALNET_AMOUNT_REFUNDED_CHILD_TID_MESSAGE'  => '. Die neue TID %s für den erstatteten Betrag: %s latuet',
    ...
    'NOVALNET_ADMIN_UPDATE_VERSION'                   => '<h2><b>Novalnet-Zahlungsplugin V11.4.3</b></h2>',
