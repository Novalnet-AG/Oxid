...
<div id="nn_new_card_div" style=[{$aCCDetails.new_details_style}]>
    <div class="form-group">
      [{if $aShoppingDetails.iShopType == '1' && $aCCDetails.aSavedDetails != ''}]
        ...
        <iframe id="novalnetiframe" scrolling="no" style="border-style:none !important;margin-left:7%;" height="100% !important"></iframe>
        [{* Iframe default style *}]

        <input type="hidden" id="novalnet_cc_form_details"   value='[{$aCCFormDetails}]'>
        <input type="hidden" id="novalnet_cc_iframe"   value="[{$oView->getNovalnetConfig('blCreditcardInlineForm')}]">
